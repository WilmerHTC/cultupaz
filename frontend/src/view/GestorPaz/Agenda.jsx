                                        ...
                                        <div className='container-fluid table-responsive p-0'>
                                            <table className='table align-items-center mb-0'>
                                                <thead className='table-primary'>
                                                    <tr>
                                                        <th className='text-center text-uppercase text-dark text-xxs font-weight-bolder opacity-7'>sugerencias</th>
                                                    </tr>
                                                </thead>

                                                <tbody className='justify-content-center'>
                                                    {data.map((asistencias, idasistencia) => {
                                                        return <tr key={idasistencia}>
                                                            <td className='align-middle text-center mb-0 text-sm text-center'>{asistencias.descripcion_asistencia}</td>
                                                        </tr>
                                                    })}
                                                </tbody>
                                            </table>
